...
async function load() {
    try {
        ...
        const categoriesS = document.getElementById("categories");

        category.forEach((element) => {
            let opt = document.createElement("option");
            opt.value = element;
            opt.innerText = element;
            categoriesS.appendChild(opt);
        });
        ...
        blogall.forEach((element) => {
            ...
            switch (cat) {
                ...
                case "Programming":
                    ...
                    break;
                case "Culture":
                    card.innerHTML += "<img src = './images/culture.png' alt='image' height='200px' width='300px'></img>";
                    break;
                case "Design":
                    card.innerHTML += "<img src = './images/design.png' alt='image' height='200px' width='300px'></img>";
                    break;
                case "Education":
